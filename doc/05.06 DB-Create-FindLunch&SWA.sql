...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`country` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`restaurant_type` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(30) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
CREATE  TABLE IF NOT EXISTS `FindLunchAndSWA`.`restaurant` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  INDEX `fk_restaurant_swa_sales_person1_idx` (`swa_sales_person_id` ASC),
  CONSTRAINT `fk_restaurant_countries1`
    FOREIGN KEY (`country_code` )
    REFERENCES `FindLunchAndSWA`.`country` (`country_code` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_restaurant_restaurant_type1`
    FOREIGN KEY (`restaurant_type_id` )
    REFERENCES `FindLunchAndSWA`.`restaurant_type` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_restaurant_swa_sales_person1`
    FOREIGN KEY (`swa_sales_person_id` )
    REFERENCES `FindLunchAndSWA`.`swa_sales_person` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`user_type` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(30) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`account_type` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(30) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`account` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_account_account_type1`
    ...
    REFERENCES `findlunchandswa`.`account_type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`course_types` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_course_restaurant1`
    ...
    REFERENCES `findlunchandswa`.`restaurant` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)  
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`user` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_user_user_type1`
    ...
    REFERENCES `findlunchandswa`.`user_type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_account1`
    FOREIGN KEY (`account_id`)
    REFERENCES `findlunchandswa`.`account` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`favorites` (
  ...
  CONSTRAINT `fk_user_has_restaurant_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `findlunchandswa`.`user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`kitchen_type` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(30) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `FindLunchAndSWA`.`offer` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
  `swa_change_request_id` INT NULL ,
  `restaurant_id` INT(11) NOT NULL ,
  ...
  `swa_comment_of_last_change` TEXT NULL ,
  `swa_last_changed_by` INT NULL ,
  `swa_blocked` TINYINT(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) ,
  INDEX `fk_product_restaurant1_idx` (`restaurant_id` ASC) ,
  INDEX `fk_product_course_idx` (`course_type` ASC) ,
  UNIQUE INDEX `swa_change_request_id_UNIQUE` (`swa_change_request_id` ASC) ,
  INDEX `fk_offer_swa_sales_person1_idx` (`swa_last_changed_by` ASC) ,
  ...
  CONSTRAINT `fk_productcourse1`
    ...
    REFERENCES `FindLunchAndSWA`.`course_types` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_offer_swa_sales_person1`
    FOREIGN KEY (`swa_last_changed_by` )
    REFERENCES `FindLunchAndSWA`.`swa_sales_person` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`user_pushtoken` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `user_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`offer_has_day_of_week` (
  ...
  CONSTRAINT `fk_offer_has_day_of_week_day_of_week1`
    ...
    REFERENCES `findlunchandswa`.`day_of_week` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_offer_has_day_of_week_offer1`
    FOREIGN KEY (`offer_id`)
    REFERENCES `findlunchandswa`.`offer` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`offer_photo` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `offer_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`time_schedule` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `restaurant_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`opening_time` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_opening_time_time_schedule1`
    ...
    REFERENCES `findlunchandswa`.`time_schedule` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`push_notification` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `user_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`push_notification_has_day_of_week` (
  ...
  CONSTRAINT `fk_push_notification_has_day_of_week_push_notification1`
    ...
    REFERENCES `findlunchandswa`.`push_notification` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`push_notification_has_kitchen_type` (
  `push_notification_id` INT(11) NOT NULL,
  ...
  CONSTRAINT `fk_push_notification_has_kitchen_type_kitchen_type1`
    ...
    REFERENCES `findlunchandswa`.`kitchen_type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`restaurant_has_kitchen_type` (
  `restaurant_id` INT(11) NOT NULL,
  `kitchen_type_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`points` (
  `user_id` INT(11) NOT NULL,
  `restaurant_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`euro_per_point` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`minimum_profit` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`bill` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_bill_minimum_profit1`
    ...
    REFERENCES `findlunchandswa`.`minimum_profit` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`reservation` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_reservation_euro_per_point1`
    ...
    REFERENCES `findlunchandswa`.`euro_per_point` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_reservation_bill1`
    FOREIGN KEY (`bill_id`)
    REFERENCES `findlunchandswa`.`bill` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`booking_reason` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`booking` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_booking_booking_reason1`
    ...
    REFERENCES `findlunchandswa`.`booking_reason` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`donation_per_month` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `date` DATE NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`bill_counter` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`allergenic` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`offer_has_allergenic` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `offer_id` INT(11) NOT NULL,
  ...
  CONSTRAINT `fk_offer_has_allergenic_allergenic1`
    ...
    REFERENCES `findlunchandswa`.`allergenic` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `findlunchandswa`.`offer_has_additives` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `FindLunchAndSWA`.`swa_sales_person` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `password` VARCHAR(255) NOT NULL ,
  ...
  INDEX `fk_swa_sales_person_country1_idx` (`country_code` ASC) ,
  CONSTRAINT `fk_swa_sales_person_country1`
    FOREIGN KEY (`country_code` )
    REFERENCES `FindLunchAndSWA`.`country` (`country_code` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `FindLunchAndSWA`.`swa_protocol_contact_way`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `FindLunchAndSWA`.`swa_protocol_contact_way` (
  `id` INT NOT NULL ,
  `name` VARCHAR(60) NOT NULL ,
  PRIMARY KEY (`id`) )
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `FindLunchAndSWA`.`swa_protocol_categories`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `FindLunchAndSWA`.`swa_protocol_categories` (
  `id` INT NOT NULL ,
  `name` VARCHAR(60) NOT NULL ,
  PRIMARY KEY (`id`) )
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `FindLunchAndSWA`.`swa_protocol`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `FindLunchAndSWA`.`swa_protocol` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `restaurant_id` INT(11) NOT NULL ,
  `contact_way_id` INT NOT NULL ,
  `categories_id` INT NOT NULL ,
  `date` DATE NOT NULL ,
  `entry_typ` VARCHAR(60) NOT NULL ,
  `comment` TEXT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_swa_protocol_restaurant1_idx` (`restaurant_id` ASC) ,
  INDEX `fk_swa_protocol_swa_protocol_contact_way1_idx` (`contact_way_id` ASC) ,
  INDEX `fk_swa_protocol_swa_protocol_categories1_idx` (`categories_id` ASC) ,
  CONSTRAINT `fk_swa_protocol_restaurant1`
    FOREIGN KEY (`restaurant_id` )
    REFERENCES `FindLunchAndSWA`.`restaurant` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_swa_protocol_swa_protocol_contact_way1`
    FOREIGN KEY (`contact_way_id` )
    REFERENCES `FindLunchAndSWA`.`swa_protocol_contact_way` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_swa_protocol_swa_protocol_categories1`
    FOREIGN KEY (`categories_id` )
    REFERENCES `FindLunchAndSWA`.`swa_protocol_categories` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

-- -----------------------------------------------------
-- Table `FindLunchAndSWA`.`swa_tour`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `FindLunchAndSWA`.`swa_tour` (
  `id` INT NOT NULL ,
  `sales_person_id` INT NOT NULL ,
  `name` VARCHAR(60) NOT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_swa_tour_swa_sales_person1_idx` (`sales_person_id` ASC) ,
  CONSTRAINT `fk_swa_tour_swa_sales_person1`
...
-- -----------------------------------------------------
-- Table `FindLunchAndSWA`.`swa_tour_details`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `FindLunchAndSWA`.`swa_tour_details` (
  `tour_id` INT NOT NULL ,
  `position` INT NOT NULL ,
  `restaurant_id` INT(11) NOT NULL ,
  PRIMARY KEY (`tour_id`, `position`) ,
  INDEX `fk_swa_tour_details_restaurant1_idx` (`restaurant_id` ASC) ,
  INDEX `fk_swa_tour_details_swa_tour1_idx` (`tour_id` ASC) ,
  CONSTRAINT `fk_swa_tour_details_restaurant1`
    FOREIGN KEY (`restaurant_id` )
    REFERENCES `FindLunchAndSWA`.`restaurant` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_swa_tour_details_swa_tour1`
    FOREIGN KEY (`tour_id` )
    REFERENCES `FindLunchAndSWA`.`swa_tour` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `FindLunchAndSWA`.`swa_todo_request_typ` (
  `id` INT NOT NULL ,
  `name` VARCHAR(60) NOT NULL ,
  PRIMARY KEY (`id`) )
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `FindLunchAndSWA`.`swa_todo_list` (
  `id` INT NOT NULL ,
  `todo_request_typ_id` INT NOT NULL ,
  `sales_person_id` INT NOT NULL ,
  `restaurant_id` INT(11) NOT NULL ,
  `offer_id` INT(11) NULL ,
  `datetime` DATETIME NOT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_swa_todo_list_swa_sales_person1_idx` (`sales_person_id` ASC) ,
  INDEX `fk_swa_todo_list_restaurant1_idx` (`restaurant_id` ASC) ,
  INDEX `fk_swa_todo_list_offer1_idx` (`offer_id` ASC) ,
  INDEX `fk_swa_todo_list_swa_todo_request_typ1_idx` (`todo_request_typ_id` ASC) ,
  CONSTRAINT `fk_swa_todo_list_swa_sales_person1`
    FOREIGN KEY (`sales_person_id` )
    REFERENCES `FindLunchAndSWA`.`swa_sales_person` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_swa_todo_list_restaurant1`
    FOREIGN KEY (`restaurant_id` )
    REFERENCES `FindLunchAndSWA`.`restaurant` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_swa_todo_list_offer1`
    FOREIGN KEY (`offer_id` )
    REFERENCES `FindLunchAndSWA`.`offer` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_swa_todo_list_swa_todo_request_typ1`
    FOREIGN KEY (`todo_request_typ_id` )
    REFERENCES `FindLunchAndSWA`.`swa_todo_request_typ` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
